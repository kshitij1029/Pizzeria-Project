...
import contact_back from '../../assets/contact-back.png'

const Contact = () => {
  return (
    <div className='flex justify-center items-center p-3 bg-contain overflow-hidden' style={{backgroundImage: `url(${contact_back})`}} >
        <div className='flex flex-col items-center w-[60%] '>
          <h1 className='font-extrabold text-cyan-800 inline-block mr-3 text-[40px]'>DELIVERY IN 30 MIN !!</h1>
