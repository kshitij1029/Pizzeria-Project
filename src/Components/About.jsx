...
const About = () => {
  return (
    <div className='flex justify-evenly py-10 px-15'>
        <img className='h-[40%] w-[25%] ' src={about_img}/>
        <div className='flex flex-col px-10 justify-evenly pb-10'>
            <h1 className='text-[50px] font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#900] via-[#f00] to-[#f00]'>Dine-in to the Finest</h1>
