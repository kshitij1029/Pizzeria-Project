...
const Hero = () => {
  return (
    <div className="h-screen w-screen bg-cover flex justify-center items-center pt-14 " style={{backgroundImage: `url(${hero_back})`}}>
        <div className='flex justify-evenly items-center w-screen'>
          ...
          <div className='text-white flex flex-col w-[35%] items-start transition ease-in-out duration-200 delay-200'>
