...
const NonVeg = ({addToCart}) => {
  return (
    <div className='flex flex-wrap'>
      <Card image={mixed} head="Mixed Maza" ingredients="Chicken Acahari, Mushrooms, Capsicum, Onions, Gauda Cheese" price={229} addToCart={addToCart}/>
      <Card image={indi} head="Indi Chicken" ingredients="Chicken slices with Indi Sauce, Cheese and Veggies" price={329} addToCart={addToCart}/>
      <Card image={dominator} head="Ultimate Dominator" ingredients="Pepproni Chicken, Chicken Sausage, Chicken Tikka, Cheese" price={329} addToCart={addToCart}/>
